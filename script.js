...
if (question17 ==="b") {
    document.write("<section><h2> 17. What is Mr.Mumms favorite animal? </h2> <h3> Question 17 is correct! Mr.Mumms faveorite animal is a zebra! </h3> </section> ")
}
if (question17 !=="b") {
    document.write("<section><h2> 17. What is Mr.Mumms favorite animal? </h2> <h3> Question 17 is incorrect. Mr.Mumms faveorite animal is a zebra. </h3> </section> ")
}

 //-----------------------------------Question 18-------------------------------------//

if (question18 ==="c") {
    document.write("<section><h2> 18. What is Nates favorite animal? </h2> <h3>Question 18 is correct! Nates favorite animal is a blob fish? hes a weirdo. </h3> </section> ") 
}
if (question18 !=="c") {
    document.write("<section><h2> 18. What is Nates faveorite animal? </h2> <h3> Question 18 is incorrect. Nates favorite animal is a blob fish? hes a weirdo. </h3> </section> ") 
}

 //-----------------------------------Question 19-------------------------------------//

 if (question19 ==="b") {
    document.write("<section><h2> 19. What is Lilys favorite animal </h2> <h3> Question 19 is correct! Lilys favorite animal is a bear. </h3> </section> ")
 }
 if (question19 !=="b") {
    document.write("<section><h2> 19. What is Lilys favorite animal </h2> <h3> Question 19 is incorrect. Lilys favorite animal is a bear. </h3> </section> ")
 }

 //-----------------------------------Question 20-------------------------------------//

if (question20 ==="a") {
    document.write("<section><h2> 20. What is Joedens favorite animal? </h2> <h3> Question 20 is correct! Joedens favorite animal is an Okapi because he is also a weirdo. </h3> </section> ")
}
if (question20 !=="a") {
    document.write("<section><h2> 20. What is Joedens favorite animal? </h2> <h3> Question 20 is incorrect. Joedens favorite animal is an Okapi because he is also a weirdo. </h3> </section>  ")
}

 //-----------------------------------Question 21-------------------------------------//

 if (question21 ==="b") {
    document.write("<section><h2> 21. What is Tyis favorite animal? </h2> <h3> Question 21 is correct! Tyis favorite animal is a siberian tiger. </h3> </section> ")
 }

if (question21 ==="b") {
    document.write("<section><h2> 21. What is Tyis favorite animal? </h2> <h3> Question 21 is incorrect. Tyis favorite animal is a siberian tiger. </h3> </section> ")
}
  }
